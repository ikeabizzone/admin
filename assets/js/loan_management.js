...
function stats(key) {
  ...
  ref51.on("value", function (snapshot4) {
    ...
    var totalbalance3 = firebase.database().ref().child("mybalance").child(phone);
    ...
    var userbalance = firebase.database().ref().child("userbalance").child(phone);
    ...
    var balancerecord = firebase.database().ref().child("balance_record").child(phone);
...
function validate556() {
  ...
  var t4 = parseInt(sourceInput2) + parseInt(t2);
...
console.log(ke2);
  ...
  if (didConfirm == true) {
    ...
    database.ref('balance_record').child(phone).child(parseInt(6000 - user_balance)).set({
    ...
    database.ref('userbalance').child(phone).child(parseInt(6000 - user_balance)).set({
      'title': 'Deposit',
    ...
    database.ref('mybalance').child(parseInt(phone)).set({
    ...
    /*
        ...
        database.ref('outfund').child(ke2).set({
 ...
 database.ref('deposit_slot').child(phone).set({
